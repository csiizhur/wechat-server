...
CREATE TABLE `sys_notice` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=utf8 COMMENT='系统公告';
...
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8 COMMENT='系统权限表';
...
INSERT INTO `sys_privilege` VALUES ('43', 'MessageManager', 'all', '0', '消息管理');
INSERT INTO `sys_privilege` VALUES ('44', 'textMessageList', 'all', '43', '文本消息列表');
INSERT INTO `sys_privilege` VALUES ('45', 'TextMessageManager', 'add', '43', '添加文本消息');
INSERT INTO `sys_privilege` VALUES ('46', 'TextMessageManager', 'update', '43', '修改文本消息');
INSERT INTO `sys_privilege` VALUES ('47', 'TextMessageManager', 'delete', '43', '删除文本消息');
...
INSERT INTO `sys_user` VALUES ('1', 'admin', 'ICy5YqxZB1uWSwcVLSNLcA==', '0', null, '0', null, null, '2016-06-08 11:08:42', '小黑', '0');
...
INSERT INTO `weixin_company` VALUES ('1', 'ccc11', 'ccc22', '/OA/upload/201606071010322341464839683258.jpg', '1', '2016-06-07 09:04:55', '0');
