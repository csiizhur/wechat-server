...
<body style="background:#ececec">
    ...
    <div class="pet_content pet_content_list">
      <div class="pet_article_like">
        ...
        <div class="pet_list_one_info">
            ...
            <div class="pet_list_one_info_r">
                <div class="pet_list_tag pet_list_tag_xxs">资质荣誉</div>
            </div>
        </div>
        <div class=" am-u-sm-8 am-list-main pet_list_one_nr">
            <h3 class="am-list-item-hd pet_list_one_bt"><a href="###" class="">${p.title}</a></h3>
            <div class="am-list-item-text pet_list_one_text">${p.content} …</div>

        </div>
          <div class="am-u-sm-4 am-list-thumb">
            <a href="###" class="">
              <img src="${pageContext.request.contextPath}/${p.pic} " class="pet_list_one_img" alt=""/>
            </a>
          </div>
      </li>
      </c:forEach>
      <!-- <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_list_one_block">
        <div class="pet_list_one_info">
            ...
            <div class="pet_list_one_info_r">
                <div class="pet_list_tag pet_video_tag">资质荣誉</div>
            </div>
        </div>
        <div class=" am-u-sm-8 am-list-main pet_list_one_nr">
            <h3 class="am-list-item-hd pet_list_one_bt"><a href="###" class="">国家计量认证</a></h3>
            <div class="am-list-item-text pet_list_one_text">2012年4月16日通过国家计量认证，认证批件编号为2012100268S..</div>

        </div>
          <div class="am-u-sm-4 am-list-thumb pet_video_info">
            <div class="pet_video_info_tag"><i class="iconfont">&#xe62d;</i>03:50</div>
            <a href="###" class="">
              <img src="img/zk06.jpg" class="pet_list_one_img" alt="我很囧，你保重....晒晒旅行中的那些囧！"/>
            </a>
          </div>
      </li>
      <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_list_one_block">
        <div class="pet_list_one_info">
            ...
            <div class="pet_list_one_info_r">
                <div class="pet_list_tag pet_list_tag_zzs">资质荣誉</div>
            </div>
        </div>
        <div class=" am-u-sm-8 am-list-main pet_list_one_nr">
            <h3 class="am-list-item-hd pet_list_one_bt"><a href="###" class="">中华人民共和国环境保护部化学品测试合格实验室一级认证</a></h3>
            <div class="am-list-item-text pet_list_one_text">2012年12月27日获得中华人民共和国环境保护部化学品测试合格实验室一级认证，认证编号为GLP(E)-2012-1002..</div>

        </div>
          <div class="am-u-sm-4 am-list-thumb">
            <a href="###" class="">
              <img src="img/zk07.jpg" class="pet_list_one_img" alt="我很囧，你保重....晒晒旅行中的那些囧！"/>
            </a>
          </div>
      </li>
            ...
            <div class="pet_list_one_info_r">
                <div class="pet_list_tag pet_list_tag_stj">资质荣誉</div>
            </div>
        </div>
        <div class=" am-list-main">
            <h3 class="am-list-item-hd pet_list_one_bt"><a href="###" class="">中华人民共和国农业部农药良好实验室规范B级认证</a></h3>
  ...
  am-avg-md-3 am-avg-lg-3 am-gallery-default pet_list_one_list" >
      ...
      <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="img/zk08.jpg"  alt="终会走过这条遥远的道路"/>
            </a>
        </div>
      </li>
  </ul>
            <div class="am-list-item-text pet_list_two_text">2012年12月19日由中华人民共和国农业部公告第1876号公告公布符合中华人民共和国农业部农药良好实验室规范B级认证..</div>
        </div>
      </li>

            <li class="am-g am-list-item-desced pet_list_one_block">
              <div class="pet_list_one_info">
            <div class="pet_list_one_info_tytj"><i class="iconfont pet_nav_kantuya pet_more_list_block_line_ico pet_list_tytj_ico">&#xe607;</i>中华人民共和国农业部农药环境毒理、毒理学A级GLP认证</div>
            <div class="pet_list_one_info_r">
  ...
  am-avg-md-3 am-avg-lg-3 am-gallery-default pet_list_one_list pet_list_one_tytj" >
      <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="img/zk09.jpg"  alt="某天 也许会相遇 相遇在这个好地方"/>
            </a>
        </div>
      </li>
      <li>
